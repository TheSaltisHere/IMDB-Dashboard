...
df=list.files(path='D:/Projects and Practice/DS PROJECT/CSV FILES') %>% 
  lapply(read_csv) %>% 
  bind_cols() 


write.csv(df,"D:/Projects and Practice/DS PROJECT/final.csv")


df=read.csv("D:/Projects and Practice/DS PROJECT/final.csv")
